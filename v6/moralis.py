...
web3Thread = Web3(Web3.WebsocketProvider(bscNode))
...
def getTokenPriceMoralis(tokenAddress):
...
def getPair(tokenAddress):
                tokenAddress = web3Thread.toChecksumAddress(tokenAddress)
                contract = web3Thread.eth.contract(address=pancakeSwapFactoryAddress, abi=listeningABI)
...
def getReserves(pairAddressforReserves):  # fundamental code for liquidity detection
        pairAddressforReserves = web3Thread.toChecksumAddress(pairAddressforReserves)
        router = web3Thread.eth.contract(address=pairAddressforReserves, abi=pairABI)
...
def getTokenPrice(tokenAddress):
        ...
        BNBPrice = getTokenPricePancake(WBNBAdress)
